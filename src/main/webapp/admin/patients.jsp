...
<div class="m-5 p-1">
    <div border="1" class = "table table-striped table-responsive-md">
        ...
        <table border="1">
            <tr>
                <th>
                    <a href="/api/admin/patients?page=${currentPage}&sortBy=firstName">
                        <fmt:message key="login.firstName"/>
                    </a>
                </th>
                <th>
                    <a href="/api/admin/patients?page=${currentPage}&sortBy=lastName">
                        <fmt:message key="login.lastName"/>
                    </a>
                </th>
                <th>
                    <a href="/api/admin/patients?page=${currentPage}&sortBy=birthDate">
        ...
        <table border="1" cellpadding="2" cellspacing="2">
            <tr>
                <c:if test="${currentPage != 1}">
                    <td><a href="/api/admin/patients?page=${currentPage - 1}&sortBy=${sortBy}">
                ...
                <c:forEach begin="1" end="${noOfPages}" var="i">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <td><a href="/api/admin/patients?page=${i}&sortBy=${sortBy}">${i}</a></td>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
